	...
	<form class="form-inline" id = "vendorImport" method="post" action = "/ordersnew/public/reports/importVendor">
	...
	<?php else : ?>
	<form class="form-inline" id = "updExcelImportForm" method="post" enctype="multipart/form-data" action = "/ordersnew/public/reports/addExcel">
	...
	<form class="form-inline" id = "vendorSectionImport" method="post" action = "/ordersnew/public/reports/importVendorSection">
	...
	<form class="form-inline" id = "sectionImport" method="post" action = "/ordersnew/public/reports/importSection">
