...
?>
	...
	<button type="button" class="btn btn-primary single"><a style="color:white" target="_blank" href="/ordersnew/public/export/reportExport/<?= $data['report'][0]['report_id']?>"><span class="glyphicon glyphicon-export"></span> Export</a></button>
	...
	<button type="button" class="btn btn-success single"><a style="color:white" href="/ordersnew/public/reports/singleSection/<?= $data['report_id']?>"><span class="glyphicon glyphicon-filter"></span> Filter by Section</a></button>
</div>
