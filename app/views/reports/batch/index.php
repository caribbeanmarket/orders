...
<div class="row newReport">
	<form method="POST" action="/ordersnew/public/reports/add_item" class="form-inline" id="newItemsForm">
	    ...
	    <div class="form-group">
	  	...
	  	<button type="button" class="btn btn-primary" id="reset" name="reset"><a style="color:white" href="/ordersnew/public/reports/reset"><span class="glyphicon glyphicon-refresh"> </span> RESET</a></button>
	  	<button type="button" class="btn btn-primary" id="resetBatch" name="reset"  style="margin-right:10px"><a style="color:white" href="/ordersnew/public/reports/addItems"><span class="glyphicon glyphicon-repeat"> </span> UPDATE</a></button>
	  	<button type="button" class="btn btn-primary" id="view" name="view"  style="margin-right:10px"><a style="color:white" href="/ordersnew/public/home"><span class="glyphicon glyphicon-eye-open"> </span> VIEW</a></button>
	  	<button type="button" class="btn btn-success" id="save" name="save"><a style="color:white" href="/ordersnew/public/reports/save_report"><span class="glyphicon glyphicon-save"> </span> SAVE</a></button>
